...
public class MegaCenterWeatherPlugin implements Plugin{
	...
	public Map<String, String> generateMessage() {
		...
		try
		{
			...
			GetMethod getMethod=new GetMethod("http://weather.raychou.com/?/detail/59481/count_1/rss");
	...
	public String aboutPlugin() {
		// TODO Auto-generated method stub
		return "Weather Plugin For Mega Center!";
	}

	@Override
	public String getPluginName() {
		// TODO Auto-generated method stub
		return "Mega Center Weather Plugin!";
	}
	...
	{
		Plugin p=new MegaCenterWeatherPlugin();
