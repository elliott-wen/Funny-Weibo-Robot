...
public class HongkongWeatherPlugin implements Plugin{
	...
	public Map<String, String> generateMessage() {
		...
		try
		{
			...
			GetMethod getMethod=new GetMethod("http://weather.raychou.com/?/detail/45005/count_1/rss");
	...
	public String aboutPlugin() {
		// TODO Auto-generated method stub
		return "Weather Plugin For Hongkong!";
	}

	@Override
	public String getPluginName() {
		// TODO Auto-generated method stub
		return "Hongkong Weather Plugin!";
	}
	...
	{
		Plugin p=new HongkongWeatherPlugin();
